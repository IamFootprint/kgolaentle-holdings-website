      ...
      <section className="relative py-24 bg-secondary overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 text-center">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            We&apos;re here to assist. Reach out by phone, email, or drop us a
            message below.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h3 className="font-heading font-bold text-secondary text-lg mb-1">Phone</h3>
                  <a href="tel:+27870937316" className="text-gray-500 hover:text-primary transition-colors">
                    +27 (0) 87 093 7316
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h3 className="font-heading font-bold text-secondary text-lg mb-1">Email</h3>
                  <a href="mailto:info@kgolaentle.com" className="text-gray-500 hover:text-primary transition-colors">
                    info@kgolaentle.com
                  </a>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="w-11 h-11 rounded-full bg-green-500 text-white flex items-center justify-center hover:bg-green-600 transition-all hover:scale-110"
                    aria-label="WhatsApp"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-11 h-11 rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 text-white flex items-center justify-center hover:opacity-90 transition-all hover:scale-110"
